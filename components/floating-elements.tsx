...
export default function FloatingElements() {
  ...
  // Rocket animation
  const rocketY = useTransform(scrollY, [0, windowHeight * 5], [windowHeight * 0.8, -windowHeight * 0.5])
  const rocketX = useTransform(
    scrollY,
    [0, windowHeight, windowHeight * 2, windowHeight * 3, windowHeight * 4, windowHeight * 5],
    ["10%", "20%", "70%", "30%", "80%", "50%"],
  )
  ...
  const astronautY = useTransform(scrollY, [0, windowHeight * 5], [windowHeight * 0.2, windowHeight * 3])
  ...
  const earthY = useTransform(scrollY, [0, windowHeight * 5], [windowHeight * 1.5, windowHeight * 4])
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Rocket className="h-full w-full text-blue-600" />
