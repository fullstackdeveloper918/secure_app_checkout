    ...
    <section ref={sectionRef} className="relative py-24 overflow-hidden" id="about">
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-foreground/80 dark:text-blue-300 mb-12">
          ...
          <motion.div variants={containerVariants} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <p className="text-foreground/80 dark:text-blue-300">Your launchpad to other galaxies</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-foreground">IT Services</h3>
              <p className="text-foreground/80 dark:text-blue-300">Mission control for every dimension</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-foreground">Cloud Solutions</h3>
              <p className="text-foreground/80 dark:text-blue-300">Ascend to new galaxies of efficiency</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-foreground">Cybersecurity</h3>
              <p className="text-foreground/80 dark:text-blue-300">Deflector shields up at all times</p>
            </motion.div>
          </motion.div>
        </motion.div>
      </div>
